  ...
  const handleClick = () => {
    switch (type) {
      ...
      case "device":
        ...
        router.push("/projekty/uslugowe");
        break;
      case "interaction":
        router.push("/projekty/przemyslowe");
        break;
      case "live-app":
        router.push("/projekty/jednorodzinne");
        break;
      case "blockchain":
      ...
      case "A":
        ...
        break;
      case "B":
        router.push("/projekty/urbanistyka");
        break;
      default:
        break;
    }
  ...
  return (
    <button
      ...
      className={combination(
        "group flex flex-col rounded border-[0.5px] border-grey-700 hover:border-white bg-grey-800/40 backdrop-blur-sm text-left duration-300 ease-linear",
        className
      )}
      {...props}
    >
